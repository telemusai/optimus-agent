...
- The Python REPL is the model-facing control environment. Typed host requests return authoritative operations to the Rust session in `crates/pi-coding-agent/`.
